...
export class VFileMessage extends Error {
   ...
   * State of problem.
   *
   * * `true` 鈥?error, file not usable
   * * `false` 鈥?warning, change may be needed
   * * `undefined` 鈥?change likely not needed
   *
  ...
  /**
   * Specify the source value that鈥檚 being reported, which is deemed
   * incorrect.
   *
   * @type {string | undefined}
   */
   ...
   *
   * > 馃憠 **Note**: this must be an absolute URL that can be passed as `x`
   * > to `new URL(x)`.
   *
   * @type {string | undefined}
   */
