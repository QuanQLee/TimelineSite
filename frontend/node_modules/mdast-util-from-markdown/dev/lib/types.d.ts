...
export interface CompileData {
  /**
   * Whether we鈥檙e inside a hard break.
   */
  ...
  /**
   * Whether we鈥檙e in flow code.
   */
  flowCodeInside?: boolean | undefined

  /**
   * Whether we鈥檙e in a reference.
   */
  inReference?: boolean | undefined

  /**
   * Whether we鈥檙e expecting a line ending from a setext heading, which can be slurped.
   */
 ...
 * with an optional error handler for when that token isn鈥檛 closed properly.
 */
