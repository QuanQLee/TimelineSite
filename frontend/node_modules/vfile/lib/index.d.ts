export class VFile {
     ...
     *
     * *   `string` or `Uint8Array` 鈥?`{value: options}`
     * *   `URL` 鈥?`{path: options}`
     * *   `VFile` 鈥?shallow copies its data over to the new file
     * *   `object` 鈥?all fields are shallow copied over to the new file
     *
     ...
     *
     * It鈥檚 OK to store custom data directly on the file but moving it to
     * `data` is recommended.
     *
     * @type {Data}
     */
     ...
     *
     * Cannot be set if there鈥檚 no `path` yet.
     *
     ...
     *
     * > 馃 **Note**: also has obsolete signatures.
     *
     * @overload
     * @param {string} reason
     ...
     *   Character encoding to understand `value` as when it鈥檚 a `Uint8Array`
     *   (default: `'utf-8'`).
     * @returns {string}
     *   Serialized file.
     */
